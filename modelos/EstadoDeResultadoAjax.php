...
$html .= "<h3 style='text-align:center;'>CHACHALACA S.A</h3><br>"; 
...
$ventas = DetalleModel::estado_resultado(5101,$fecha_inicio,$fecha_fin);
	...
	$porcentaje = 0.25; if ($ventas > 25000) { $porcentaje = 0.30; }
	...
	$html .= "<td></td>";
	$html .= "<td style='color:red'> $ ".number_format(round($utilidad_ejercicio,2), 2, ',', ',')."</td>";
	$html .= "</tr>";
