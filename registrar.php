...
<head>
    ...
    <!-- Title Page-->
    <link rel="shortcut icon" href="images/logotpimini.png" />
    <title>Cooperativa Don Teco </title>
                ...
                <div class="login-wrap">
                    <div class="login-content">
                        <div class="login-logo bg-primary">
                            <a href="#">
                                <img src="images/222.png" alt="CDT">
                            </a>
                        </div>
                        <div class="login-form">
                        <form action="modelos/usuario.php?op=4" method="post">
                                <div class="form-group text-center">
                                    <label><b>REGISTRARSE</b></label>
                                </div>
