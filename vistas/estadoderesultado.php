                  ...
                  <div class="row ">
                    <div class="col-md-12"> 
                        <div class="card">
                          ...
                          <H2 style="color: white;"><i class="fas fa-list"></i> Estado de Resultado</H2>
                          </div>
                            <div class="card-body">
                                ...
                                <div class="row col-lg-12">
                                  ...
                                  <div class="col-lg-6">
                                    <button type="button" class="btn btn-success btn-block" id="btn_busqueda4"> <i class="fa fa-check"></i> Ver Estado de Resultado</button>
                                    <br>
                                    <button type="button" class="form-control btn btn-primary"  id="btn_imprimir3"> <span class="glyphicon glyphicon-print " aria-hidden="true"></span><i class="fas fa-print"></i> Imprimir Estado de Resultado</button>
                                  </div>
                                  <div class="col-lg-3"></div>
                                </div>
                            </div>
