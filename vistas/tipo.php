                  ...
                  <div class="row ">
                    <div class="col-md-12"> 
                        <div class="card">
                          ...
                          <i class="fas fa-list"></i>   LISTA DE TIPOS DE SALDO
                          </div>
                            <div class="card-body">
                                            <div class="row">
...
<script type="text/javascript" src="../jsvistas/jsTipo.js"></script>
...
<div class="modal fade" id="modalEliminar" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true" style="display: none;">
            <div class="modal-dialog modal-dialog-centered" role="document">
              <div class="modal-content">
                ...
                <form id="formEliminarTipo" method="POST" action="../modelos/tipo.php?op=3">
    ...
    <div class="modal fade" id="modalNuevo" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true" style="display: none;">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                    ...
                    <h5 class="modal-title text-white" id="exampleModalLongTitle"><i class="fa fa-plus"></i>  Agregar Tipo De Cuenta</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                    </div>
                    <form id="formNuevoTipo" method="POST" action="../modelos/tipo.php?op=1">
                        <div class="modal-body">
                            <div class="form-group">
    ...
    <div class="modal fade" id="modalEditar" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true" style="display: none;">                             
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                    ...
                    <h5 class="modal-title text-white" id="exampleModalLongTitle"><i class="fa fa-edit"></i>   Editar Tipo De Cuenta</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                    </div>
                    <form id="formEditarTipo" method="POST" action="../modelos/tipo.php?op=2">
                        <div class="modal-body">
                            <div class="form-group">
