...
class DetalleModel{
	...
	public static function listar(){
		...
		$query = Connection::connect()->prepare("SELECT * FROM detallediario");
		$query->execute();
	...
	public static function getPartida($partida){
		...
		$query = Connection::connect()->prepare("SELECT * FROM detallediario WHERE idpartida=:partida");
	...
	public static function agregarDetalle($data){
		$query = Connection::connect()->prepare("INSERT INTO detallediario(codigo,idpartida,monto,movimiento) VALUES (:codigo,:id,:monto,:movimiento)");
	...
	public static function editarDetalle($data){
		$query = Connection::connect()->prepare("UPDATE detallediario SET monto=:monto,movimiento=:movimiento WHERE idpartida=:id AND codigo=:codigo");
		$query->bindParam(":id",$data["id"],PDO::PARAM_STR);
		$query->bindParam(":codigo",$data["codigo"],PDO::PARAM_STR);
		$query->bindParam(":monto",$data["monto"],PDO::PARAM_STR);
		$query->bindParam(":movimiento",$data["movimiento"],PDO::PARAM_STR);
	...
	public static function comprobar($codigo,$partida){
		$query = Connection::connect()->prepare("SELECT * FROM detallediario WHERE codigo=:codigo AND idpartida=:partida");
		$query->bindParam(":partida",$partida,PDO::PARAM_STR);
	...
	public static function sumaMovimiento($partida,$movimiento){
		$query = Connection::connect()->prepare("SELECT SUM(monto) as total FROM detallediario WHERE idpartida=:partida AND movimiento=:movimiento");
		$query->bindParam(":partida",$partida,PDO::PARAM_STR);
...
public static function total2($data){
	...
	public static function borrarDetalle($partida){
		$query = Connection::connect()->prepare("DELETE FROM detallediario WHERE  idpartida=:id");
